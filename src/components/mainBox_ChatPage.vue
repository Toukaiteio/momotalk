<template>
    <div class="_chatPage_Container" :class="{notShot:!PageState.isScreenShotting,shot:PageState.isScreenShotting}">
        ...
        <div class="_chatPage_ChatDetail_Wrapper">
            <div class="chat_ContentContainer"  v-if="PageState.onSelectIndex!=-1 && (typeof PageState.onChatFlow[PageState.onSelectStudentData.Id.toString()] != 'undefined') ">
                ...
                <div class="chat_BaseObject" v-for="(chatitem,chatindex) in PageState.onChatFlow[PageState.onSelectStudentData.Id.toString()]" :key="chatindex"  :class="isNohead(chatitem.type,chatindex)">
                    <div v-if="chatitem.type.indexOf('self')==-1&&chatitem.type.indexOf('statetext')==-1" class="userAvatar">
                    ...
                    <div class="userChatContent" v-if="chatitem.type.indexOf('image')==-1">
                        <div class="userName" v-if="chatitem.type.indexOf('self')==-1&&chatitem.type.indexOf('statetext')==-1">{{_PD.studentList[chatitem.slIndex].Name}}</div>
                        <div class="Content">
        ...
        <div class="screenShotEl" :class="{notShot:!PageState.isScreenShotting,shot:PageState.isScreenShotting}" id="chatBox"  v-if="PageState.onSelectIndex!=-1 && (typeof PageState.onChatFlow[PageState.onSelectStudentData.Id.toString()] != 'undefined')">
                ...
                <div class="chat_BaseObject" v-for="(chatitem,chatindex) in PageState.onChatFlow[PageState.onSelectStudentData.Id.toString()]" :key="chatindex"  :class="isNohead(chatitem.type,chatindex)">
                    <div class="userAvatar" v-if="chatitem.type.indexOf('self')==-1&&chatitem.type.indexOf('statetext')==-1">
                        <img v-if="parseInt(chatitem.slIndex)>-1" :src="_PD.avatarList[chatitem.slIndex]">
                    </div>
                    <div class="userChatContent" v-if="chatitem.type.indexOf('image')==-1">
                        <div class="userName" v-if="chatitem.type.indexOf('self')==-1&&chatitem.type.indexOf('statetext')==-1">{{_PD.studentList[chatitem.slIndex].Name}}</div>
            ...
            <div class="mainbox">
                <div class="inputer_wrapper">
                    ...
                    <div class="inputer_block config">
                        ...
                        <div class="inputer_item" v-if="PageState.preChatFlow[PageState.onSelectStudentData.Id.toString()][PageState.preChatOnSelected]&&PageState.isNameChanging==false&&(PageState.preChatFlow[PageState.onSelectStudentData.Id.toString()][PageState.preChatOnSelected].type.indexOf('self')!=-1||_PD.studentList[PageState.preChatFlow[PageState.onSelectStudentData.Id.toString()][PageState.preChatOnSelected].slIndex])">
...
const openCreator=()=>{
    if(!PageState.preChatFlow[PageState.onSelectStudentData.Id.toString()]){
        PageState.preChatFlow[PageState.onSelectStudentData.Id.toString()]=JSON.parse(JSON.stringify(PageState.onChatFlow[PageState.onSelectStudentData.Id.toString()]));
    }
